    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="container-radio">
        <div>
            ...
            <input type="radio" id="cafe" name="tipo" value="Café" <?= $produto->getTipo() == Tipo::CAFE  ? "checked" : ""?>>
        </div>
        <div>
            <label for="almoco">Almoço</label>
            <input type="radio" id="almoco" name="tipo" value="Almoço" <?= $produto->getTipo() == Tipo::ALMOCO  ? "checked" : ""?>>
        </div>
    </div>
      ...
      <input type="text" id="preco" name="preco" placeholder="Digite um preço" value="<?= $produto->getPrecoFormatado()?>" required>
